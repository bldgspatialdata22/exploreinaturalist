...
MD_masternat_coastal_sf <- sf::st_as_sf(MD_masternat_coastal_drop_na, coords =c("longitude", "latitude"), crs = st_crs(4269))
```
...
MD_masternat_piedmont_drop_na <- MD_masternat_piedmont %>% 
  drop_na(latitude)
#Convert iNaturalist dataframes into sf objects
MD_masternat_piedmont_sf <- sf::st_as_sf(MD_masternat_piedmont_drop_na, coords = c("longitude", "latitude"), crs = st_crs(4269))
```
...
MD_biodiversity_drop_na <- MD_biodiversity %>% 
  drop_na(latitude)
#Convert iNaturalist dataframes into sf objects
MD_biodiversity_sf <- sf::st_as_sf(MD_biodiversity_drop_na, coords = c("longitude", "latitude"), crs = st_crs(4269))
```
...
```{r}
#Check CRS again
st_crs(MD_masternat_coastal_std)
st_crs(MD_masternat_piedmont_std)
st_crs(MD_biodiversity_std)
