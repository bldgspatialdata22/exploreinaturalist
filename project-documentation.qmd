...
MD_masternat_coastal_sf <- sf::st_as_sf(MD_masternat_coastal_drop_na, coords = c("latitude", "longitude"))
```
...
#Remove rows in dateframe with NA values
MD_masternat_piedmont_drop_na <- MD_masternat_coastal %>% 
  drop_na(latitude)
#Convert iNaturalist dataframes into sf objects
MD_masternat_piedmont_sf <- sf::st_as_sf(MD_masternat_piedmont_drop_na, coords = c("latitude", "longitude"))
```
...
MD_biodiversity_drop_na <- MD_biodiversity %>% 
  drop_na(latitude)
#Convert iNaturalist dataframes into sf objects
MD_biodiversity_sf <- sf::st_as_sf(MD_biodiversity_drop_na, coords = c("latitude", "longitude"))
```
