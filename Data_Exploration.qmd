...
masternat_map
ggsave("masternat_map.png", plot = masternat_map, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")
```
...
ggsave("masternat_user_plot.png", plot = masternat_user_plot, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")
...
ggsave("piedmont_user_map.png", plot = piedmont_user_map, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")
...
ggsave("coastal_usermap.png", plot = coastal_user_map, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")

# Filter out observations from the user with the most observations according to masternat_user_plot
tonyiajohnson_obs <- 
  filter(coastal_researchgrade, user.login == "tonyiajohnson")
# Map top user's observations
topuser_coastal <- ggplot() +
  ...
  coord_sf(xlim = c(-75.0, -78.0), ylim = c(38.0, 40.0)) +
  scale_fill_brewer(
    type = "seq",
    palette = "OrRd"
    ) +
...
ggsave("topuser_coastal.png", plot = topuser_coastal, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")
```
...
MD_corvid_sightings
#FIXME: Center title position
ggsave("MD_corvid_sightings.png", plot = MD_corvid_sightings, path = "C:/Users/Kari/Documents/GitHub/exploreinaturalist/deliverables")
```
...
MD_rare_insects_inc <- MD_insects_by_family %>%
  dplyr::filter(n == 1)
# Drop geometry before performing join
